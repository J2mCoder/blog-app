            ...
            <div className="flex flex-col">
              <div className="w-full flex flex-col md:flex-row justify-between">
                ...
                <div className="flex space-x-0 md:space-x-3 space-y-3 md:space-y-0 flex-col md:flex-row">
                  <div className="w-full flex items-center text-white mt-3 md:mt-0">
                    <input
                      type="file"
                      name="image"
                      id="image"
              ...
              <div className="w-full mt-3 flex flex-wrap gap-3 transition-all duration-500">
              ...
              <div className="my-3 h-fit">
                <img
                  src={img}
                  alt=""
                  className=" h-[300px] lg:h-fit w-full object-cover"
                />
              </div>
